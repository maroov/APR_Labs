...
\captionof{figure}{Error en función de PCA para $\alpha = 1$}
\newpage
\includegraphics[width=250px]{1_41_2}
\captionof{figure}{Grafica del error en función de PCA para $\alpha = 1$}
\end{center}
...
\captionof{figure}{Error en función de PCA para diversos valores de $\alpha$}
\end{center}
$ \\ $
\includegraphics[width=\textwidth]{1_42_2}
\captionof{figure}{Intervalos de confianza del error vs PCA para diversos valores de $\alpha$}
$ \\ $
\includegraphics[width=\textwidth]{1_42_3}
\captionof{figure}{Grafica del error en función de PCA para diversos valores de $\alpha$}
$ \\ $
...
\captionof{figure}{Error en función de PCA para diversos valores de $\alpha$ con $k=1$}
\end{center}
$ \\ $
\begin{center}
\includegraphics[width=\textwidth]{1_52_2}
\captionof{figure}{Intervalos de confianza para el error en función de PCA para diversos valores de $\alpha$ con $k=1$}
\end{center}
$ \\ $
