...
\captionof{figure}{Valores de dimensionalidad reducida mediante PCA contra valores de neuronas en la capa oculta, usando el 50\% de las muestras para entrenamiento.}
\includegraphics[width=200px]{2_mnist}
\captionof{figure}{Valores de dimensionalidad reducida mediante PCA contra valores de neuronas en la capa oculta, usando el 80\% de las muestras para entrenamiento.}
\includegraphics[width=200px]{2_mnist}
