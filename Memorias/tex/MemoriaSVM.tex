...
%Por ejemplo \textit{C = 10} y \textit{C = 1000} se ha comprobado que los resultados son prácticamente idénticos (excepto los multiplicadores de Lagrange, que se tienen que adaptar al cambio en la \textit{C}).
